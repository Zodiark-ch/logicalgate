...
subgraph=torch.load("ioi_subgraph_noising_1000.pth")
...
out = exp.call_metric_with_corr(exp.corr, things.test_metrics["kl_div"], things.test_data)
print("KL is", out)

out_logit = exp.call_metric_with_corr(exp.corr, things.test_metrics["logit_diff"], things.test_data)
print("logit_diff", out_logit)
