...
parser.add_argument('--task', type=str, required=False, choices=task_choices, default="greaterthan",help=f'Choose a task from the available options: {task_choices}')
...
exp.save_edges("noising_reverse_0.01_edges.json")
...
#%%
exp.save_subgraph('ioi_subgraph_noising_0.01_reverse.pth',
    return_it=True,
)
